...
// GetGoroutineId Will return this goroutine's identifier if set. If you always need a
...
// EnsureGoroutineId Will call cb with the current goroutine identifier. If one hasn't already
